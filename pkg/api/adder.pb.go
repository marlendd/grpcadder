...
const file_adder_proto_rawDesc = "" +
	"\n" +
	"\vadder.proto\x12\x03api\"(\n" +
	"\n" +
	"AddRequest\x12\f\n" +
	"\x01x\x18\x01 \x01(\x05R\x01x\x12\f\n" +
	"\x01y\x18\x02 \x01(\x05R\x01y\"%\n" +
	"\vAddResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x05R\x06result23\n" +
	"\x05Adder\x12*\n" +
	"\x03Add\x12\x0f.api.AddRequest\x1a\x10.api.AddResponse\"\x00B'Z%github.com/marlendd/grpcadder/pkg/apib\x06proto3"
